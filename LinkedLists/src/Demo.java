...
public class Demo {
    public static void main(String[] args) {
        ...
        addInOrder(placesToVisit, "Peru");
        addInOrder(placesToVisit, "Germany");
        addInOrder(placesToVisit, "Holland");
        addInOrder(placesToVisit, "Greenland");
        addInOrder(placesToVisit, "Bora Bora");
        addInOrder(placesToVisit, "Norway");


//        placesToVisit.add("Sydney");
//        placesToVisit.add("Peru");
//        placesToVisit.add("Germany");
//        placesToVisit.add("Holland");
//        placesToVisit.add("Greenland");
